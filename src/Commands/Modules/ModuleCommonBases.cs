...
namespace Volte.Commands.Modules
{
    public sealed partial class UtilityModule : VolteModule
    {
        ...
        public static readonly Dictionary<string[], string> ZalgoNamedArguments = new Dictionary<string[], string>()
        {
            {
                new[] { "max" },
                "Use the highest intensity and include every character type. This option takes no value."
            },
        ...
        public static string GetNato(char i) =>
            _nato.TryGetValue(char.ToLower(i), out var nato)
                ? nato
        ...
        private (IOrderedEnumerable<(string Name, bool Value)> Allowed,
            IOrderedEnumerable<(string Name, bool Value)> Disallowed)
            GetPermissions(IGuildUser user)
        {
    ...
    public sealed partial class ModerationModule : VolteModule
    {
        ...
        public static readonly Dictionary<string[], string> UnixBanNamedArguments = new Dictionary<string[], string>
        {
            ...
            {
                new[] { "reason" },
                "The reason for the ban. If this is not provided, the reason will be \"Banned by a Moderator.\""
            },
            {
                new[] { "shadow" },
